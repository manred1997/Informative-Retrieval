...
if __name__ == '__main__':
    ...
    parser.add_argument("--inner_hidden", type=int, default=512, help="Dimension of inner hidden representation of FFN")
    parser.add_argument("--n_layers", type=int, default=2, help="Number of enriched block")
    
    parser.add_argument("--threshold", type=float, default=0.5, help="Number of enriched block")

    parser.add_argument("--num_type_label", type=int, default=6, help="Number of enriched block")
    parser.add_argument("--num_ministry_label", type=int, default=39, help="Number of enriched block")
    ...
    parser.add_argument("--tuning_metric", default="overall_f1", type=str, help="Metrics to tune when training")
